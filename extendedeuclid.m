function [gcd,u,v] = extendedeuclid(P1,P2,m)
%EXTENDEDEUCLID    Extended Euclidean Algorithm for polynomials
%    EXTENDEDEUCLID(P1,P2,m) performs the extended euclidean algorithm to
