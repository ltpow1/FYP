...
%    [decodederror] = patterson(encodedmesswerr,g,G,H,L,m, synd)
%    
%
...
n = 2^m;
k = n-m*t;
if nargin == 5 %niederreiter will supply it's own syndrome
    synd = encodedmesswerr*H';
end

syndarray = synd.x;
%convert synd from GF(2) to GF(2^m) polynomial
for i = 1:t
